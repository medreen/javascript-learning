...
function findPaye(tax_inc){
    ...
    if (tax_inc <= 24000 && tax_inc >= 0){
        ...
        paye = (24000 * 0.1) + 8333 * 2.5
    } else if (tax_inc <= 500000 && tax_inc > 32333){
        paye = (24000 * 0.1) + (8333 * 2.5) + (467667 * 0.3) 
    } else if (tax_inc <= 800000 && tax_inc > 500000){
        paye = (24000 * 0.1) + (8333 * 2.5) + (467667 * 0.3) + 300000 * 0.325
    } else if (tax_inc > 800000){
        paye = (24000 * 0.1) + (8333 * 2.5) + (467667 * 0.3) +( 300000 * 0.325) + (800000 * 0.35);
    }
    return paye - relief
}
