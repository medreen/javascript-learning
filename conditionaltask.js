...
temp = Number(prompt("Enter user temperature(degrees celcius): "))
...
if (x >= 10 && x <= 20 && y > 100) {
    console.log(`${x} and ${y}  meet condition.`)
} else {
    console.log(`${x} and ${y} don't meet condition.`)
}


secret_password = "secret123"
if (password == secret_password) { console.log("Access granted.") } else {console.log("Access denied.")}
